...
parser.add_argument('--folder_path', default='examples', type=str,
                    help='The folder path')
parser.add_argument('--train_filename', default='./data_flist/places2/train_shuffled.flist', type=str,
                    help='The output filename.')
parser.add_argument('--validation_filename', default='./data_flist/places2/validation_shuffled.flist', type=str,
                    help='The output filename.')
